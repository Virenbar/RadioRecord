<template>
  <header class="navbar navbar-expand-lg navbar-dark px-3 sticky-top">
    <nav class="container font-monospace">
      <NuxtLink class="navbar-brand mx-auto" to="https://virenbar.github.io/RadioRecord/">
        <img
          height="36" width="112"
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <NuxtLink class="nav-link" target="_blank" to="https://radiorecord.ru/">
              Сайт радио Record
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink class="nav-link" target="_blank" to="https://github.com/Virenbar/RadioRecord/tree/master/playlists">
              Плейлисты в M3U
            </NuxtLink>
          </li>
        </ul>
